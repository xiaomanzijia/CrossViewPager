...
import me.licheng.crossviewpager2.R;

/**
 * Draws a line for each page. The current page line is colored differently
 * than the unselected page lines.
 */
public class LinePageIndicator extends View implements ILinePageIndicator {
...
//                if (mViewPager.isFakeDragging()) mViewPager.endFakeDrag();
    ...
    @Override
    public void setViewPager(IViewPager viewPager) {
    ...
    @Override
    public void setViewPager(IViewPager view, int initialPosition) {
        setViewPager(view);
